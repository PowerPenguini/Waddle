...
**What to build:** Browse the desktop's shared recent-file history without creating a separate Waddle activity database.
...
- [x] Disabled Recent stops presenting activity in Waddle.
...
The virtual location is read-only for Waddle file operators and returns to the last real folder
when left.
